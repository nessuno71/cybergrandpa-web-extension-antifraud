...
export const WEIGHTED_PATTERNS: readonly WeightedPattern[] = [
  ...
  {
    re: /setTimeout\s*\(\s*["'`][^"'`]*["'`]/gi,
    weight: 6,
    category: ThreatCategory.OBFUSCATION,
    minScanLevel: ScanLevel.LIGHT,
  },
  {
    re: /setInterval\s*\(\s*["'`][^"'`]*["'`]/gi,
    weight: 3,
    category: ThreatCategory.OBFUSCATION,
    minScanLevel: ScanLevel.DEEP,
  },
  ...
  {
    re: /createElement\s*\(\s*["'`]iframe["'`]/gi,
    weight: 3,
    category: ThreatCategory.DOM_INJECTION,
    minScanLevel: ScanLevel.DEEP,
  },
  {
    re: /createElement\s*\(\s*["'`]script["'`]/gi,
    weight: 3,
    category: ThreatCategory.DOM_INJECTION,
    minScanLevel: ScanLevel.DEEP,
  },
  ...
  // Keylogging patterns
  {
    re: /addEventListener\s*\(\s*["'`]keydown["'`]/gi,
    weight: 9,
    category: ThreatCategory.KEYLOGGING,
    minScanLevel: ScanLevel.LIGHT,
  },
  {
    re: /addEventListener\s*\(\s*["'`]keyup["'`]/gi,
    weight: 9,
    category: ThreatCategory.KEYLOGGING,
    minScanLevel: ScanLevel.LIGHT,
  },
  {
    re: /addEventListener\s*\(\s*["'`]keypress["'`]/gi,
    weight: 9,
    category: ThreatCategory.KEYLOGGING,
    minScanLevel: ScanLevel.LIGHT,
  },
  ...
  {
    re: /addEventListener\s*\(\s*["'`]key/gi,
    weight: 9,
    category: ThreatCategory.KEYLOGGING,
    minScanLevel: ScanLevel.LIGHT,
  },
  ...
  // Form hijacking
  {
    re: /addEventListener\s*\(\s*["'`]submit["'`]/gi,
    weight: 3,
    category: ThreatCategory.FORM_HIJACK,
    minScanLevel: ScanLevel.DEEP,
  },
